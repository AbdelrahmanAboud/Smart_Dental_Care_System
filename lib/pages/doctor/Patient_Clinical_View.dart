              ...
              StreamBuilder<DocumentSnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (userData != null && userData['oralScore'] != null) {
                    riskScore = (userData['oralScore']['score'] ?? 0).toInt();
                  } else {
                    riskScore = 0;
                  }
                  Color riskColor = riskScore >= 80
                      ? Colors.greenAccent
                      : (riskScore >= 60
                            ? Colors.orangeAccent
                            : Colors.redAccent);
                        ...
                        Container(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage:
                                ...
                                : const AssetImage("lib/assets/user_logo.png")
                                      as ImageProvider,
                          ),
                        ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) =>
                              TreatmentPlan(patientId: widget.patientId),
                        ),
                      );
                    },
                    child: const Text(
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () =>
                        _showAddBillingSheet(context, currentPatientName),
                  ),
                ),
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: servicesList.isEmpty
                      ? null
                      : () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                "Invoice sent to Receptionist successfully!",
                              ),
                            ),
                          );
                        },
