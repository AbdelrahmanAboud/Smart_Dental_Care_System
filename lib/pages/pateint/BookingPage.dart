  ...
  Future<void> _fetchSlotsFromFirebase(DateTime date) async {
    ...
    try {
      ...
      if (slotDoc.exists && slotDoc.data() != null) {
        List<dynamic> slots = slotDoc.get('slots');
        setState(() {
          todaySlots = List<String>.from(slots);
        });
      }
    } catch (e) {
                ...
                child: Padding(
                  ...
                  child: TableCalendar(
                    ...
                    onDaySelected: (selected, focused) {
                      ...
                      _fetchSlotsFromFirebase(selected);
                    },
                    headerVisible: false,
      ...
      return Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(colors: [accentCyan, Colors.transparent]),
          ),
          child: Container(
