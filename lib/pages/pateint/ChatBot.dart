...
class _ChatBotState extends State<ChatBot> {
  ...
  final String _apiKey = "AIzaSyA6jKs9zVRncayhZb7CGz-Mkmz_P1Rdk9c";
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "AI Assistant Active",
                      style: TextStyle(color: aiThemeColor, fontSize: 11),
                    ),
                  ],
                ),
              ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isMe
              ...
              : aiThemeColor.withOpacity(0.12),
          border: isMe
              ? null
              : Border.all(color: aiThemeColor.withOpacity(0.2)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            Icons.auto_awesome,
            color: aiThemeColor.withOpacity(0.3),
            size: 60,
          ),
          ...
          const SizedBox(height: 8),
          const Text(
            "How can I help you with your teeth today?",
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [aiThemeColor, const Color(0xFF6366F1)],
                ),
              ),
              child: const Icon(
                Icons.send_rounded,
