...
class HomePage extends StatefulWidget {
  @override
  State<HomePage> createState() => _PatientDashboard();
}
class _PatientDashboard extends State<HomePage> {
          ...
          children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Text("Upcoming Appointments",style: TextStyle(color: Colors.white,fontSize:18,fontWeight: FontWeight.w600),),
                          const SizedBox(height: 5),
                          Row(
                              children: [
                                ...
                                Text("monday, june 10, 10:00 AM",style: TextStyle(color:Colors.white,fontSize: 16),),
                                const Spacer(),
                                Icon(FontAwesomeIcons.clock,color: primaryBlue ,size: 15),
            ...
            Padding(
              ...
              child: Container(
                ...
                child :Text("Quick Access",style: TextStyle(color: Colors.white,fontSize:18,fontWeight: FontWeight.w600),),
